...
all_customers_model = admin.model(
    'Admin get all customers',
    {
        'cust_id': fields.Integer(description='An ID'),
        'customer_name': fields.String(required=True, description='A customer name'),
        'email': fields.String(required=True, description='An email'),
        'phone': fields.Integer(required=True, description='A phone number')
    }
)

all_product_model = admin.model(
...
#
#     @admin.marshal_with(all_customers_model)
#     @jwt_required()
#     def get(self):
...
#
#     @admin.marshal_with(all_product_model)
#     @jwt_required()
#     def get(self):
...
#
#     @admin.expect(all_product_model)
#     @admin.marshal_with(all_product_model)
#     @jwt_required()
#     def post(self):
